    ...
    <main className="flex flex-1 flex-col items-center px-6 pt-[18vh] pb-24">
      <div className={`w-full max-w-md ${inter.className}`}>
        <p className="text-left text-[14px] leading-snug">
          <strong className="font-semibold">Portbrowser</strong>{" "}
          <span className="text-[12px] text-[#9A9A9C] dark:text-[#6E6E73]">
            v0.1.0
            <a
              ...
              className="inline-block align-[-0.15em] ml-0.5 text-[#007AFF] opacity-90 dark:text-[#0A84FF] transition-opacity hover:opacity-100"
            >
          ...
          is a native macOS app for previewing websites at true iPhone
          dimensions. Open localhost, LAN, or HTTPS URLs in accurate iPhone
          frames, powered by SwiftUI and WebKit.
        </p>
