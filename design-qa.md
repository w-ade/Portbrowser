...
- Source visual truth: `Sources/Portbrowser/Resources/iphone-status-bar.svg`
- Implementation screenshot: `/private/tmp/portbrowser-svg-status-window.png`
- Focused comparison: `/private/tmp/portbrowser-svg-status-comparison.png`
- Viewport: iPhone 17 portrait, 402 x 62 point status area inside a 402 x 874 viewport
- State: light appearance, Portbrowser displaying the Aptdex local server
...
- The reopened fixed 366 x 795 Portbrowser window shows the complete 402 x 874 logical viewport with the status area occupying its top 62 points.
...
- Post-fix evidence: `/private/tmp/portbrowser-svg-status-comparison.png`.
...
- [x] Build, close, and reopen Portbrowser.
