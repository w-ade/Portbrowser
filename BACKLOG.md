...
- **Spec:** define the final defaults keys and migrate existing Port Browser recent URLs/settings once when the renamed app first launches.
...
- **Done means:** Port Browser uses a fixed 366 x 795 visible viewport backed by a 402 x 874 logical mobile webview.
